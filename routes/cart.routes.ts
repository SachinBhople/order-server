...
cartrouter
    ...
    .delete("/delete-product/:id", userProtected, cartController.deleteItemFromCart) // Delete a specific product from cart
    .delete("/delete-all-products", userProtected, cartController.deleteAllCart) // Delete all products for a user
    .get("/get-all-products", userProtected, cartController.getAllCartItems) // Get all cart items for a user
